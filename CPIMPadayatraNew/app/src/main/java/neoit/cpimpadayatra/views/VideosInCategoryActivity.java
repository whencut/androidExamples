...
public class VideosInCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_videos_in_category);

        getSupportActionBar().setTitle(getIntent().getExtras().getString("cname"));
    ...
    private void submitDataToServer() {
        pb = new ProgressDialog(VideosInCategoryActivity.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.VIDEOS,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        //Toast.makeText(VideosInCategoryActivity.this, response, Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        pb.dismiss();
                        Toast.makeText(VideosInCategoryActivity.this, "Server Down.", Toast.LENGTH_LONG).show();
                    }
                }) {
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> params = new HashMap<String, String>();
                params.put("category_id", ""+getIntent().getExtras().getString("cat"));
                return params;
            }
        };
// Add the request to the RequestQueue.
    ...
    private void parseFeedbackdData(String response){
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                img_url[i]=jObj.getString("video_id");
    ...
    private void displayFeedbackDetails(){
        gv_sample = (ListView) findViewById(R.id.gv_sample);
    ...
    private class FeedbackAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if(convertView==null){
                ...
                convertView=  li.inflate(R.layout.row_gallery3, null);
            }
            ...
            cv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent= new Intent(getApplicationContext(),YoutubeDemo.class);
                    intent.putExtra("img_url",img_url[position]+"");
