    ...
    private class FeedbackAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if(convertView==null){
                ...
                convertView=  li.inflate(R.layout.row_videos, null);
            }
            ...
            Glide.with(getApplicationContext()).load(img_url[position]).listener(new RequestListener<String, GlideDrawable>() {
                @Override
            ...
            title.setText(category[position]);
            ...
            cv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("cname",category[position]+"");
